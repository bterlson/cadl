import { User, UserCreatedResponse, UserExistsResponse, ApiError, InvalidUserResponse, Standard4XxResponse, Standard5XxResponse, TodoPage, TodoItem, TodoLabelRecord, TodoFileAttachment, TodoUrlAttachment, InvalidTodoItem, NotFoundResponse, TodoItemPatch, NoContentResponse } from "./models.js";

export function recordSerializer(record: Record<string, any>, convertFn: (item: any) => any): Record<string, any> {
